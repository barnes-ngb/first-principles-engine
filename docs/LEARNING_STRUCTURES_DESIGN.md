...
- **AI project suggestion** from interests + the evaluation frontier — "targeting system → delivery
  ...
  Teaching Help** design (help-card games as Play). *Note: `docs/TODAY_TEACHING_HELP_DESIGN.md` is
  not present on this branch's base as of this writing — it is referenced here as a sibling design
  to reconcile with once it lands.*
