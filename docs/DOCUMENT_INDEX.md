...
| `EVALUATION_SYSTEM_FULL_SWEEP_2026-05.md` | **NEW** (PR #1172) | May 2026 evidence-first full sweep: R1-R6 verification, journey traces, G55 hardcoded-Lincoln finding, phantom-write tier, post-Phase-1+2 gap re-sweep. |
