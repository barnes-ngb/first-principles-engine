...
| `CAPTURE_PIPELINE_INVESTIGATION_2026-04-07.md` | **NEW** | Data-freshness investigation: Today per-item capture vs curriculum scan are parallel pipelines writing to different collections (`artifacts` vs `scans`). Today captures never update ActivityConfig or curriculum view. Includes fix options. |
