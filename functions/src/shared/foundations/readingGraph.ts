 ...
 * inline edit here.
 *
 * THE definition lives here (UX-296): both projects compile this file, so the
 * Cloud Functions' concept names come from the same nodes the app seeds against.
 * `src/core/foundations/readingGraph.ts` keeps its path and re-exports.
 */

import type { ConceptGraph } from './types.js'
