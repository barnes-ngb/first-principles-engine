...
// `deriveChildIdFromDocId` no longer lives here: it has one definition in
// `functions/src/shared/docId.ts` (ARCH-47 slice 2) and its cases — these
// included, verbatim — moved to `functions/src/shared/docId.test.ts`.
