      ...
      sections: [
        {
          ...
          lines: [
            ...
            'My own look changes what is in it.',
          ],
        },
        stylesSection('kid'),
        {
      ...
      sections: [
        {
          ...
          lines: [
            ...
            '"+ My own look" is the other axis: a look decides how the drawing is redrawn, and your own words decide what changes in it — "put her in a space suit". The look you tapped still applies, and the note is one-off, never saved.',
          ],
        },
      ...
      sections: [
        {
          ...
          lines: [
            ...
            '"+ My own look" adds one change to what is in the picture — "put her in a space suit", "give him a cape" — while the look you tapped still decides how it is drawn. One-off, never saved, and it costs nothing extra by itself.',
          ],
        },
        stylesSection('parent'),
        {
          ...
          lines: [
            ...
            'Keep "My own look" to one change, and say what it looks like rather than naming it — the same rule the picture maker applies to every other prompt applies to your words here.',
          ],
        },
        budgetSection('parent'),
        neverSection('parent'),
