...
export const WRITING_MAP: CurriculumDomainMap = {
  ...
  nodes: [
    // FOUNDATION
    // FEAT-11: practiceIdeas across the writing map are deliberately tap/voice \u2014
    // NO pencil/handwriting (tracing, sand/salt tray, copy-by-hand, look-cover-write).
    // Lincoln's block is the *mechanics* of handwriting, not the ideas, so the
    // planner must never route him to a pencil. The node structure is retained;
    // only its (pencil-first) practice ideas were neutralized.
    { id: 'writing.mechanics.letterFormation', domain: 'writing', label: 'Letter formation', description: 'Recognizes and builds letters by sound and shape', tier: 'foundation', dependencies: [], assessmentTypes: ['writing'], practiceIdeas: ['Build letters from stroke tiles on screen', 'Name the letter you hear', 'Match letter to its sound'] },
    { id: 'writing.mechanics.spacing', domain: 'writing', label: 'Word spacing', description: 'Knows where one word ends and the next begins', tier: 'foundation', dependencies: ['writing.mechanics.letterFormation'], assessmentTypes: ['writing'], practiceIdeas: ['Tap word-tiles into a sentence with gaps', 'Hear a sentence and place the word breaks', 'Spot the run-together words on screen'] },
    // BUILDING
    { id: 'writing.mechanics.spelling', domain: 'writing', label: 'Phonetic spelling', description: 'Spells words by sounding them out \u2014 readable even if not conventional', tier: 'building', dependencies: ['writing.mechanics.letterFormation'], assessmentTypes: ['writing'], practiceIdeas: ['Spell-the-word tiles: hear it, tap the sounds', 'Sound it out together', 'Word-family tile swaps'] },
    { id: 'writing.mechanics.capitalization', domain: 'writing', label: 'Capitalization & punctuation', description: 'Uses capital letters at starts of sentences and periods at ends', tier: 'building', dependencies: ['writing.mechanics.spacing'], assessmentTypes: ['writing'], practiceIdeas: ['Tap the capital and the period into a sentence', 'Spot the missing capital on screen', 'Hear a sentence and place the end mark'] },
    { id: 'writing.composition.sentence', domain: 'writing', label: 'Complete sentences', description: 'Builds complete thoughts with a subject and verb', tier: 'building', dependencies: ['writing.mechanics.spacing'], assessmentTypes: ['writing'], practiceIdeas: ['Sentence starters', 'Fix the fragment game (tap to reorder)', 'Expand a word into a spoken sentence'] },
    // DEVELOPING
    { id: 'writing.mechanics.conventionalSpelling', domain: 'writing', label: 'Conventional spelling', description: 'Spells common words correctly, uses spelling patterns', tier: 'developing', dependencies: ['writing.mechanics.spelling'], assessmentTypes: ['writing'], practiceIdeas: ['Word-pattern tile sorts', 'Hear it, build it from tiles', 'Personal word wall on screen'] },
